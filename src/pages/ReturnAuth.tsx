...
const ReturnAuth: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center sm:text-left">
      <LoadingOverlay isVisible={loading} message="Scanning for transactions..." />
      
      <div className="w-full max-w-2xl bg-white rounded-[3rem] shadow-2xl border border-slate-200 overflow-hidden">
        <div className="p-10 border-b border-slate-100 flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-black text-slate-900 tracking-tight">Return Apparatus</h2>
            <p className="text-slate-500 font-medium">Verify your identity to see active borrows.</p>
          </div>
          <motion.button 
            whileTap={{ scale: 0.9 }}
